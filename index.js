...
bgm.setAttribute("src", ""); //file path for music
bgm.muted = true;

breakSound.setAttribute("src", ""); //file path for music
breakSound.muted = true;

drop.setAttribute("src", ""); //file path for music
drop.muted = true;
...
//New updates that can be made to the game
//1. Add a score counter
//2. Add a level counter
//3. Add a timer
//4. Add a pause button
//5. Add a restart button
//6. Add a game over screen
//7. Add a high score board
//8. Add a music button
//9. Add a sound effect button
//10. Add a mute button
